...
df_text = load_and_average_embeddings("/Users/sreebhargavibalija/Desktop/uflallfiles/multimodalfinal/models/client3/c3_text_final_all_patients_embeddings.csv")
df_tabular = load_and_average_embeddings("/Users/sreebhargavibalija/Desktop/uflallfiles/multimodalfinal/models/client3/c3_combined_tabular_patient_embeddings.csv")
df_image = load_and_average_embeddings("/Users/sreebhargavibalija/Desktop/uflallfiles/multimodalfinal/models/client3/c3_image_final_all_patients_embeddings.csv")
...
# ====== Step 9: Save Files ======
base_path = "/Users/sreebhargavibalija/Desktop/uflallfiles/multimodalfinal/models/client3/"
os.makedirs(base_path, exist_ok=True)

np.save(base_path + "c3_final_fused_embeddings.npy", fused_embeddings)
np.save(base_path + "c3_final_labels.npy", labels)
...
metrics_df.to_csv(base_path + "c3_metrics.csv", index=False)

conf_df = pd.DataFrame(conf_matrix, columns=["Predicted Negative", "Predicted Positive"],
                       index=["Actual Negative", "Actual Positive"])
conf_df.to_csv(base_path + "c3_confusion_matrix.csv")

fused_df = pd.DataFrame(fused_embeddings)
fused_df['label'] = labels
fused_df.to_csv(base_path + "c3_embeddings_with_labels.csv", index=False)
...
plt.grid(True)
plt.savefig(base_path + "c3_tsne_visualization.png")
plt.show()
