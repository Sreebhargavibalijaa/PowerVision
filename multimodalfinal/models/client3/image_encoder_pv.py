...
# ✅ 2. Paths
CLIENT_PATH = "/Users/sreebhargavibalija/Desktop/uflallfiles/UFM3- FederatedAgents/chestx-ray/clients/reduced_client3"
    ...
    for root, _, files in os.walk(patient_path):
        for file in files:
            if file.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp')):
                ...
                heatmap_dir = "c3_dp_prompt_patient_embeddings_csv/heatmaps"
...
final_df.to_csv("c3_image_final_all_patients_embeddings.csv", index=False)
